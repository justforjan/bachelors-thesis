...
final_11 <- all_data %>% reduce(full_join, by = c("country", "year"))
...
final_11 <- as.data.frame(final_11)
...
final_10 <- all_data %>% reduce(full_join, by = c("country", "year"))
...
final_10 <- as.data.frame(final_10)
...
final_9 <- all_data %>% reduce(full_join, by = c("country", "year"))
...
final_8 <- all_data %>% reduce(full_join, by = c("country", "year"))
...
final_7 <- all_data %>% reduce(full_join, by = c("country", "year"))
...
```{r}
# write_csv(final_all, "D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/final_all.csv")
