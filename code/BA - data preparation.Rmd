...
overview <- data.frame(titles, earliest, latest, datapoints, zero_or_below)
overview
```
...
In the poverty column many 0 values can be found. For now, I will just
delete this column
