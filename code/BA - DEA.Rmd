...
Americs <- regions$country[regions$continent == "Americs"]
...
chosen_countries <- Europe # enter a vector with strings; empty means all
...
if (!is.null(chosen_countries)) {
  if (is_empty(setdiff(chosen_countries, Europe))) {
    filename <- paste(filename, "_", "Europe", sep = "")
  } else if (is_empty(setdiff(chosen_countries, Americas))) {
    filename <- paste(filename, "_", "Americas", sep = "")
  } else if (is_empty(setdiff(chosen_countries, EU))) {
    filename <- paste(filename, "_", "EU", sep = "")
  } else if (is_empty(setdiff(chosen_countries, Africa))) {
    filename <- paste(filename, "_", "Africa", sep = "")
  } else if (is_empty(setdiff(chosen_countries, Asia))) {
