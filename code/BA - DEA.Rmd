...
```{r}
data = read_csv("D:/Daten/Bildung/HS Mannheim/BA/Data/Results/country_data_all_dmus.csv", show_col_types = FALSE)
str(data)
```
...
```{r}
write_csv(data_dea, "D:/Daten/Bildung/HS Mannheim/BA/Data/Results/dea_results.csv")
```
