...
```{r}
# GDP
wellfare_ind <- data_crs %>%
  select(dmu, country, continent, efficiencies, income)
...
# Cluster
wellfare_ind <- merge(wellfare_ind, data_crs_cluster[c("dmu", "cluster")])
