...
data_general <- merge( data_crs %>% 
                         ...
                         select(dmu, country, ,continent, year, efficiency_crs, CO2, material_footprint, foreign_investment, government_debt,life_expectancy, income, mean_years_in_school, murder), 
                       data_vrs %>% 
...
```{r}
means_year %>%
  pivot_longer(cols = c("efficiency_crs", "efficiency_vrs", "CO2", "material_footprint", "foreign_investment", "government_debt", "life_expectancy", "income", "mean_years_in_school", "murder"), names_to = "indicator") %>%
...
cluster_ind_info_mean <- data_general %>%
  select(CO2, material_footprint, foreign_investment, government_debt, life_expectancy, income, mean_years_in_school, murder, cluster) %>%
  group_by(cluster) %>%
  summarise_all(mean)
...
data_general %>%
  select(CO2, material_footprint, foreign_investment, government_debt, life_expectancy, income, mean_years_in_school, murder, cluster) %>%
  pivot_longer(cols = c("CO2", "material_footprint", "foreign_investment", "government_debt", "life_expectancy", "income", "mean_years_in_school", "murder"), names_to = "indicator") %>%
...
```{r}
km.out_mean <- kmeans(data_scale_mean, centers = 4, nstart = 200)
# print(km.out)
...
```{r}
pca_analyse <- prcomp(data_scale_mean, rank = 5)
pca_analyse$rotation[,1:5]
#?prcomp
...
```{r}
# general data sets
write_csv(data_general, "D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 112/data_general.csv")

write_csv(wellfare_ind, "D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 112/wellfare_ind.csv")

write_csv(avg_wellfare_ind, "D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 112/avg_wellfare_ind.csv")


# means and variance
write_csv(means_country, "D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 112/means_country.csv")

write_csv(means_year, "D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 112/means_year.csv")

write_csv(variance_country, "D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 112/variance_country.csv")

write_csv(variance_year, "D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 112/variance_year.csv")


# wide data sets
write_csv(data_crs_wider_eff, "D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 112/data_crs_wider_eff.csv")

write_csv(data_crs_wider_rank, "D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 112/data_crs_wider_rank.csv")

write_csv(data_vrs_wider_eff, "D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 112/data_vrs_wider_eff.csv")

write_csv(data_vrs_wider_rank, "D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 112/data_vrs_wider_rank.csv")
