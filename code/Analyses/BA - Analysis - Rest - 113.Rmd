...
# general data sets
data_general <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 113/data_general", s, ".csv", sep = ""))

wellfare_ind <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 113/wellfare_ind", s, ".csv", sep = ""))

wellfare_ind$cluster <- as.factor(wellfare_ind$cluster)

avg_wellfare_ind <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 113/avg_wellfare_ind", s, ".csv", sep = ""))


# means and variance
means_country <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 113/means_country", s, ".csv", sep = ""))

means_year <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 113/means_year", s, ".csv", sep = ""))

variance_country <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 113/variance_country", s, ".csv", sep = ""))

variance_year <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 113/variance_year", s, ".csv", sep = ""))


# wide data sets
data_crs_wider_eff <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 113/data_crs_wider_eff", s, ".csv", sep = ""))

data_crs_wider_rank <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 113/data_crs_wider_rank", s, ".csv", sep = ""))

data_vrs_wider_eff <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 113/data_vrs_wider_eff", s, ".csv", sep = ""))

data_vrs_wider_rank <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files 113/data_vrs_wider_rank", s, ".csv", sep = ""))
```
...
```{r}
sum(data_general$efficiency_crs == 1) # = 63 / 56
sum(data_general$efficiency_vrs == 1) # = 193 / 151
```
...
tail(means_country[order(-means_country$efficiency_crs),],10)
```
...
head(means_country[order(-means_country$efficiency_vrs),],10)
tail(means_country[order(-means_country$efficiency_vrs),],10)
```
...
crs_100
write_csv(as.data.frame(crs_100), "crs_100.csv")
```
...
crs_vrs_10_diff
write_csv(as.data.frame(crs_vrs_10_diff), "crs_vrs_100_diff.csv")
```
...
```{r}
cor(data_general[c("CO2", "efficiency_crs")]) # = -24 / -21
cor(data_general[c("CO2", "efficiency_vrs")]) # = -25 / -21
```
...
```{r}
cor(data_general[c("foreign_investment", "efficiency_crs")]) # = -48 / -52
cor(data_general[c("foreign_investment", "efficiency_vrs")]) # = -38 / -44
```
...
```{r}
cor(data_general[c("material_footprint", "efficiency_crs")]) # = -27 / -24
cor(data_general[c("material_footprint", "efficiency_vrs")]) # = -19 / -17
```

Small correlation (-0.3)

```{r}
cor(data_general[c("government_debt", "efficiency_crs")]) # = -43 / -42
cor(data_general[c("government_debt", "efficiency_vrs")]) # = -27 / -27
```
