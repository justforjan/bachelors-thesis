...
# general data sets
data_general <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files/data_general", s, ".csv", sep = ""))

wellfare_ind <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files/wellfare_ind", s, ".csv", sep = ""))

wellfare_ind$cluster <- as.factor(wellfare_ind$cluster)

avg_wellfare_ind <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files/avg_wellfare_ind", s, ".csv", sep = ""))


# means and variance
means_country <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files/means_country", s, ".csv", sep = ""))

means_year <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files/means_year", s, ".csv", sep = ""))

variance_country <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files/variance_country", s, ".csv", sep = ""))

variance_year <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files/variance_year", s, ".csv", sep = ""))


# wide data sets
data_crs_wider_eff <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files/data_crs_wider_eff", s, ".csv", sep = ""))

data_crs_wider_rank <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files/data_crs_wider_rank", s, ".csv", sep = ""))

data_vrs_wider_eff <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files/data_vrs_wider_eff", s, ".csv", sep = ""))

data_vrs_wider_rank <- read_csv(paste("D:/Daten/Bildung/HS Mannheim/BA/bachelors-thesis/processed_data/Working Files/data_vrs_wider_rank", s, ".csv", sep = ""))
```
...
```{r}
sum(data_general$efficiency_crs == 1) # = 63 / 53
sum(data_general$efficiency_vrs == 1) # = 193 / 127
```
...
```{r}
cor(data_general[c("CO2", "efficiency_crs")]) # = -24 / -28
cor(data_general[c("CO2", "efficiency_vrs")]) # = -25 / -28
```
...
```{r}
cor(data_general[c("foreign_investment", "efficiency_crs")]) # = -48 / -48
cor(data_general[c("foreign_investment", "efficiency_vrs")]) # = -38 / -40
```
...
```{r}
cor(data_general[c("material_footprint", "efficiency_crs")]) # = -27 / -28
cor(data_general[c("material_footprint", "efficiency_vrs")]) # = -19 / -22
```

Small correlation (-0.3)

```{r}
cor(data_general[c("government_debt", "efficiency_crs")]) # = -43 / -41
cor(data_general[c("government_debt", "efficiency_vrs")]) # = -27 / -25
```
